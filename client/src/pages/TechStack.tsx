...
Manager needs to know before speaking with the client.`}</pre>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-8">
        <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-5">
          <div className="h-12 w-12 rounded-xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center shrink-0">
            <svg className="h-6 w-6 text-emerald-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12z"/></svg>
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="font-bold text-white text-base mb-1">These agents are open source — use them in your own project</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              The <strong className="text-slate-200">CovenantEvaluationAgent</strong> and <strong className="text-slate-200">NarrativeAgent</strong> are available as a standalone TypeScript library. MIT licensed. Works with OpenAI, Anthropic, or any LLM provider.
            </p>
            <div className="flex items-center gap-2 mt-1">
              <code className="text-xs text-emerald-400 bg-slate-800 px-2 py-1 rounded font-mono">npm install covagent-agents</code>
              <span className="text-slate-500 text-xs">·</span>
              <span className="text-xs text-slate-500">MIT · TypeScript · 46 tests</span>
            </div>
          </div>
          <a
            ...
            className="flex items-center gap-2 bg-white text-slate-900 px-5 py-2.5 rounded-xl font-semibold text-sm hover:bg-slate-100 transition-colors shrink-0"
          >
